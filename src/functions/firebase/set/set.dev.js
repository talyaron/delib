      ...
      var waitForUser = setInterval(function () {
        if ({}.hasOwnProperty.call(_store["default"].user, 'uid')) {
          ...
          if (!isUserRgisterdToGroup) {
            ...
            var groupRef = (0, _firestore.doc)(_config.DB, 'users', _store["default"].user.uid, 'registerGroups', groupId);
            (0, _firestore.setDoc)(groupRef, {
              register: true
            }).then(function () {
            ...
            var memberRef = (0, _firestore.doc)(_config.DB, 'groups', groupId, 'members', _store["default"].user.uid);
            (0, _firestore.setDoc)(memberRef, userObj, {
              merge: true
            }).then(function () {
...
function setOptionActive(groupId, questionId, subQuestionId, optionId, isActive) {
  try {
    ...
    (0, _firestore.updateDoc)(optionRef, {
      isActive: isActive
    });
  } catch (err) {
    console.error(err);
